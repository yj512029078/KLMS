// Default constructors are not generated for classes
%nodefaultctor SIProfileFT;
...
namespace gloox
{
   ...
   * @since 0.9
   */
  class GLOOX_API SIProfileFT : public SIProfileHandler, 
	                            public SIHandler,
								...
								public IqHandler
  {
    public:
	  ...
	  //  if( m_socks5Manager ) 
	  //  {
	  //	  m_socks5Manager->registerSOCKS5BytestreamServer( server );
	  //	  }
	  //}
	  ...
	  //	  if( m_socks5Manager ) 
	  //	  {
	  //		  m_socks5Manager->removeSOCKS5BytestreamServer();
	  //	  }
	  // }
