...
namespace gloox
{
  ...
  class GLOOX_API Client : public ClientBase
  {
    public:
       ...
       * @since 1.0
       */
      bool bindResource( const std::string& resource ) { return bindOperation( resource, true ); }
       ...
       * resource be unbound.
       */
      bool unbindResource( const std::string& resource ) { return bindOperation( resource, false ); }
