    ...
    public:
      ...
      class MUC : public StanzaExtension
      {
        public:
          ...
          MUC( const std::string& password, 
			   HistoryRequestType historyType = HistoryUnknown,
          ...
          // reimplemented from StanzaExtension
          virtual StanzaExtension* newInstance( const Tag* tag ) const { return new MUC( tag ); }
        ...
        private:
          std::string* m_password; // JI Yixuan: why use ptr not obj ?
          std::string* m_historySince;
          HistoryRequestType m_historyType;
          int m_historyValue;

      }; // JI Yixuan: end of class MUC : public StanzaExtension
      ...
      class MUCUser : public StanzaExtension
      {
        ...
        private:
          ...
          MUCRoomRole m_role;
          std::string* m_jid; // JI Yixuan: why use ptr not obj ?
          std::string* m_actor;
          std::string* m_thread;
          std::string* m_reason;
      ...
      }; // JI Yixuan: end of class MUCUser : public StanzaExtension
    ...
    public:
      ...
      class MUCOwner : public StanzaExtension
      {
        public:
           ...
           */
          MUCOwner( const JID& alternate = JID(), const std::string& reason = EmptyString, const std::string& password = EmptyString);
          ...
          // reimplemented from StanzaExtension
          StanzaExtension* newInstance( const Tag* tag ) const { return new MUCOwner( tag ); }
      ...
      }; // JI Yixuan: end of class MUCOwner : public StanzaExtension
      ...
      class MUCAdmin : public StanzaExtension
      {
        public:
           ...
           * @param reason An optional reason for the role change.
           */
          MUCAdmin( MUCRoomRole role, const std::string& nick, const std::string& reason = EmptyString );
           ...
           * @param reason An optional reason for the role change.
           */
          MUCAdmin( MUCRoomAffiliation affiliation, const std::string& nick, const std::string& reason = EmptyString );
          ...
          // reimplemented from StanzaExtension
          StanzaExtension* newInstance( const Tag* tag ) const { return new MUCAdmin( tag ); }

          // reimplemented from StanzaExtension
          Tag* tag() const;

          // reimplemented from StanzaExtension
          virtual StanzaExtension* clone() const { return new MUCAdmin( *this ); }
      ...
      }; // JI Yixuan: end of class MUCAdmin : public StanzaExtension
