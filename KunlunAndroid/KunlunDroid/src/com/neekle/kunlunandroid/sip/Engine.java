...
public class Engine extends NgnEngine {
	...
	private void showNotification(int notifId, int drawableId, String tickerText) {
		...
		//
		// Intent intent = new Intent(KunlunApplication.getContext(),
		// Main.class);
		...
		// KunlunApplication.getContext(), notifId/* requestCode */,
		// intent, PendingIntent.FLAG_UPDATE_CURRENT);
		//
		// // Set the info for the views that show in the notification panel.
		// notification.setLatestEventInfo(KunlunApplication.getContext(),
